...
return [
    ...
    'block_editor' => [
        ...
        'block_saved_text' => 'Block saved successfully.',
        'block_saved_title' => 'Block Saved',
        'block_save_failed_text' => 'An error occurred while saving the block.',
        'block_save_failed_title' => 'Save Failed',
        'autosaved' => 'Autosaved',
        'status' => 'Status:',
    ...
    'page_manager' => [
        'page_published_text' => 'Page published successfully.',
        'page_published_title' => 'Page Published',
        'page_publish_failed_text' => 'An error occurred while publishing the page.',
        'page_publish_failed_title' => 'Publish Failed',
        'draft_saved_text' => 'Page draft saved successfully.',
        'draft_saved_title' => 'Draft Saved',
        'draft_save_failed_text' => 'An error occurred while saving the draft.',
        'draft_save_failed_title' => 'Save Failed',
        ...
        'confirm_delete_block_text' => 'Are you sure you want to delete this block? This action cannot be undone.',
        'block_deletion_failed_text' => 'An error occurred while deleting the block.',
        'block_deletion_failed_title' => 'Error',
        'block_creation_failed_text' => 'An error occurred while creating the block.',
        'block_creation_failed_title' => 'Error',
        'page_saved_text' => 'Page saved successfully.',
        'page_saved_title' => 'Page Saved',
        'page_save_failed_text' => 'An error occurred while saving the page.',
        'page_save_failed_title' => 'Error',
        'block_order_update_failed_text' => 'An error occurred while updating the block order.',
        'block_order_update_failed_title' => 'Error',
        'block_library' => 'Block Library',
        'add_content_blocks' => 'Add content blocks to your page',
        'search_blocks' => 'Search blocks...',
        'all_categories' => 'All Categories',
        'all_complexities' => 'All Complexities',
        'basic' => 'Basic',
        'intermediate' => 'Intermediate',
        'advanced' => 'Advanced',
        'no_blocks_found' => 'No blocks found matching your criteria.',
        'no_content_yet' => 'No content yet',
        'add_blocks_from_library' => 'Add blocks from the library to get started.',
    ...
    'page_canvas' => [
        'no_blocks_message' => 'This page has no content yet. Add a block from the library to get started.',
        'add_block' => 'Add Block',
        'edit_block' => 'Edit Block',
        'delete_block' => 'Delete Block',
        'duplicate_block' => 'Duplicate Block',
        'drag_to_reorder' => 'Drag to reorder blocks',
    ],
    'media' => [
        'uploader' => [
    ...
    'forms' => [
        ...
        'form_builder_interface' => [
            ...
            'save_draft_tooltip' => 'Save your current changes as a draft',
            'publish' => 'Publish',
            'publish_tooltip' => 'Publish draft changes to make them live',
            'discard_draft' => 'Discard Draft',
            'discard_draft_tooltip' => 'Discard all draft changes (cannot be undone)',
            'preview' => 'Preview',
