...
namespace App\Livewire {
    ...
    class SettingsPage {
        ...
        public static function modal($name)
        {
            return \App\Livewire\SettingsPage::modal($name);
        }
    ...
    class MediaLibrary {
        ...
        public static function modal($name)
        {
            return \App\Livewire\MediaLibrary::modal($name);
        }
    ...
    class MediaDetail {
        ...
        public static function modal($name)
        {
            return \App\Livewire\MediaDetail::modal($name);
        }
...
namespace App\Livewire\Translations {
    ...
    class ManageTranslations {
        ...
        public static function modal($name)
        {
            return \App\Livewire\Translations\ManageTranslations::modal($name);
        }
...
namespace App\Livewire\Admin {
    ...
    class PageIndex {
        ...
        public static function modal($name)
        {
            return \App\Livewire\Admin\PageIndex::modal($name);
        }
