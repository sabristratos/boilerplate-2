...
<div class="space-y-4">
    ...
    <div class="space-y-3">
        ...
        <flux:select 
            wire:model.live="draftElements.{{ $selectedElementIndex }}.properties.mode" 
            label="Mode"
        >
        ...
        <flux:input 
            wire:model.live.debounce="draftElements.{{ $selectedElementIndex }}.properties.months" 
            type="number"
        ...
        />
        <flux:select 
            wire:model.live="draftElements.{{ $selectedElementIndex }}.properties.size" 
            label="Calendar Size"
        >
    ...
    <div class="space-y-3">
        ...
        @if(($selectedElement['properties']['mode'] ?? null) === 'range')
            <flux:input 
                wire:model.live.debounce="draftElements.{{ $selectedElementIndex }}.properties.minRange" 
                type="number"
            ...
            />
            <flux:input 
                wire:model.live.debounce="draftElements.{{ $selectedElementIndex }}.properties.maxRange" 
                type="number"
    ...
    <div class="space-y-3">
        ...
        <flux:field variant="inline">
            <flux:switch wire:model.live="draftElements.{{ $selectedElementIndex }}.properties.weekNumbers" />
            <flux:label>Show Week Numbers</flux:label>
        </flux:field>
        <flux:field variant="inline">
            <flux:switch wire:model.live="draftElements.{{ $selectedElementIndex }}.properties.selectableHeader" />
            <flux:label>Selectable Header</flux:label>
        </flux:field>
        <flux:field variant="inline">
            <flux:switch wire:model.live="draftElements.{{ $selectedElementIndex }}.properties.withToday" />
            <flux:label>Today Shortcut</flux:label>
        </flux:field>
        <flux:field variant="inline">
            <flux:switch wire:model.live="draftElements.{{ $selectedElementIndex }}.properties.withInputs" />
            <flux:label>Show Date Inputs</flux:label>
        </flux:field>
        <flux:field variant="inline">
            <flux:switch wire:model.live="draftElements.{{ $selectedElementIndex }}.properties.withConfirmation" />
    ...
    <div class="space-y-3">
        ...
        <flux:field variant="inline">
            <flux:switch wire:model.live="draftElements.{{ $selectedElementIndex }}.properties.withPresets" />
            <flux:label>Enable Presets</flux:label>
        </flux:field>
        @if($selectedElement['properties']['withPresets'] ?? false)
            <flux:textarea 
                wire:model.live.debounce="draftElements.{{ $selectedElementIndex }}.properties.presets" 
    ...
    <div class="space-y-3">
        ...
        <flux:field variant="inline">
            <flux:switch wire:model.live="draftElements.{{ $selectedElementIndex }}.properties.disabled" />
            <flux:label>Disabled</flux:label>
        </flux:field>
        <flux:field variant="inline">
            <flux:switch wire:model.live="draftElements.{{ $selectedElementIndex }}.properties.invalid" />
    ...
    <div class="space-y-3">
        ...
        <flux:input 
            wire:model.live.debounce="draftElements.{{ $selectedElementIndex }}.properties.description" 
            label="Description" 
            placeholder="Help text for users"
        />
        <flux:field variant="inline">
            <flux:switch wire:model.live="draftElements.{{ $selectedElementIndex }}.properties.descriptionTrailing" />
            <flux:label>Description Below</flux:label>
        </flux:field>
        <flux:input 
            wire:model.live.debounce="draftElements.{{ $selectedElementIndex }}.properties.badge" 
            label="Badge" 
            placeholder="e.g. Required, New"
        />
        <flux:input 
            wire:model.live.debounce="draftElements.{{ $selectedElementIndex }}.properties.locale" 
