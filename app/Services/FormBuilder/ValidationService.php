 ...
 *
 * @property ValidationRuleService $validationRuleService
 * @property ElementManager $elementManager
 *
 * @method array generateRules(array|ElementDTO $element)
 * @method array generateMessages(array|ElementDTO $element)
 * @method array getAvailableRules()
 * @method array getRelevantRules(string $fieldType)
 * @method array getRelevantRulesByCategory(string $fieldType)
 * @method array getAvailableCategories(string $fieldType)
 * @method void updateValidationRules(array &$elements, string $elementId, array $rules)
 * @method void updateValidationMessage(array &$elements, string $elementId, string $rule, string $message)
 * @method void updateValidationRuleValue(array &$elements, string $elementId, string $rule, string $value)
 */
